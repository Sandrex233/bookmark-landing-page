        ...
        <div className='mt-20'>
            <div className='flex h-[300px] items-center justify-center bg-[#5368DF]'>
                <div className='flex flex-col mx-auto space-y-8'>
                    <p className='tracking-widest text-center text-white uppercase mb-[-25px]'>35,000+ already joined</p>
                    <h1 className='max-w-sm md:max-w-md text-3xl md:text-4xl font-medium text-white text-center'>Stay up-to-date with what we’re doing</h1>
